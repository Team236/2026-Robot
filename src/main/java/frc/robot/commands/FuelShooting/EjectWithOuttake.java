...
public class EjectWithOuttake extends ParallelCommandGroup {
  /** Creates a new EjectWithOuttake. */
  public EjectWithOuttake(PreFeeder preFeeder, MainRoller mainRoller, Floor floor, BinRelease binRelease, Intake intake) {
    ...
    addCommands(
      ...
      new PIDIntake(intake, Constants.IntakeConstants.OUTTAKE_SPEED) 
    );
  }
}
