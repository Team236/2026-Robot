...
public class ManualMainRoller extends Command {
  private MainRoller mainRoller;
  private double mainMotorSetSpeed;

  /** Creates a new SpinShooterMotors. */
  public ManualMainRoller(MainRoller mainRoller, double mainMotorSetSpeed) {
  ...
  @Override
public void execute() {
  mainRoller.spinMainMotor(mainMotorSetSpeed);
}
