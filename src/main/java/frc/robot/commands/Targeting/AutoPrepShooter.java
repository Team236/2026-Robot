...
public class AutoPrepShooter extends ParallelCommandGroup {
  ...
  public AutoPrepShooter(ShooterPivot shooterPivot, MainRoller mainRoller, Swerve s_Swerve, PreFeeder preFeeder, Floor floor, Intake intake) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new PIDPivot(shooterPivot, s_Swerve),
      new PIDShoot(mainRoller, s_Swerve, preFeeder, floor, intake)
    );
  }
}
