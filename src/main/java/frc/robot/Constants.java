...
public final class Constants {
  ...
  public static final class BinReleaseConstants {
    ...
    public static final double ENC_REVS_MAX = 12.4; //TBD
    ...
    public static final double BIN_DOWN_POSSITION = 28;
  }
...
public static final class Swerve { //TODO -- UPDATE ALL VALUES / TUNE
        ...
        public static final class Mod0 { //TODO: These must be changed for each specific robot!!!
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(36.123); //36.210 //37.26 most recent //(-146.33);//(81.1+180); TESTBED//-119.79; old -120.15
        ...
        /* FRONT RIGHT Module - Module 1 */
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-172.793); //-176.045 //-173.49 most recent //(10.01);//(-20.83+180)Estbed; 130.87;old 131.045
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset); 
        }    
        ...
        public static final class Mod2 { //TODO: These must be changed for each specific robot!!!
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(67.236); //67.061 //66.97 recent //(-117.42);//(8.1+180); TESTBED //106.35; old 106.87
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod3 { //TODO: These must be changed for each specific robot!!!
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-74.092); //-74.18 //-73.91 recent //(105.9);//(-17.75+180);  TESTBED//130.87; old 130.95
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
    }
