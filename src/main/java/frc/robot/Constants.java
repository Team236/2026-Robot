...
public static final class PathPlanner {
  public static final PIDConstants TRANSLATION_PID_CONSTANTS = new PIDConstants(7.267, 0.0, 0.0); // seems like these affect movement of robot when it tries to correct itself (goes off path), not for just regular movement
  public static final PIDConstants ROTATION_PID_CONSTANTS = new PIDConstants(5, 0.0, 0.0); // ^^^^
}
...
public static final class Swerve {
        ...
        public static final class Mod0 { //TODO: This must be tuned to specific robot
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(-119.71);//(81.1+180); TESTBED//-119.79; old -120.15 // 1/27 was 160.84
        ...
        /* FRONT RIGHT Module - Module 1 */
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(134.30);//(-20.83+180)Estbed; 130.87;old 131.045 // 1/27 was 159.61
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }    
        ...
        public static final class Mod2 { //TODO: This must be tuned to specific robot
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(107.40);//(8.1+180); TESTBED //106.35; old 106.87 // 1/27 was -172.62
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        ...
        public static final class Mod3 { //TODO: This must be tuned to specific robot
            ...
            public static final int canCoderID = 0; // NOTICE THAT THIS IS ID 0 BUT MOD 3
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(131.22);//(-17.75+180);  TESTBED//130.87; old 130.95 // 1/27 was -99.84
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
    }
